...
namespace FeiBo.Synchro.Api.Areas.ST.Models
{
    ...
    public class StoreOut
    {
            ...
            public class header
            {
                    ...
                    ///客户权限分组
                    /// </summary>
                    public string cacauthcode { get; set; }
                    /// <summary>
                    ///供应商编码
                    /// </summary>
                    ...
                    ///补料标识
                    /// </summary>
                    public string iscomplement { get; set; }
            }
            /// <summary>
            /// 指定entry节点属性
            /// </summary>
            public class entry
            {
                    ...
                    ///库管员编码
                    /// </summary>
                    public string whpersoncode { get; set; }
                    /// <summary>
                    ///库管员
                    /// </summary>
                    public string whpersonname { get; set; }
                    /// <summary>
                    ///属性
                    /// </summary>
                    ...
                    ///计划批号
                    /// </summary>
                    public string planlotcode { get; set; }
            }
    }
}